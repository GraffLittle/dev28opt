...
/*if($_GET['w']>170)
	define( 'WATERMARK_OVERLAY_IMAGE', $_SERVER['DOCUMENT_ROOT'].'/watermark.png' );
else
	define( 'WATERMARK_OVERLAY_IMAGE', $_SERVER['DOCUMENT_ROOT'].'/watermark_.png' );*/
...
class timthumb {
	...
	public function __construct(){
		...
		if($this->param('b')){
			$this->src = str_replace('/var/www/28opt/data/www/28opt.ru/', '', base64_decode($this->param('b')));
		}else
	...
	protected function processImageAndWriteToCache($localImage){
		...
		$watermark = 1;//(bool) $this->param('wm', 0);
		...
		$tempfile = tempnam($this->cacheDirectory, 'timthumb_tmpimg_');
			...
			if ($watermark == 1)
			{
				...
				$new_over_width = $new_width;
				$new_over_height = floor(($new_width*$overlay_height)/$overlay_width);
				...
				imagecopy($canvas, $overlay_gd_image, $x, $y, 0, 0, $overlay_width, $overlay_height);
